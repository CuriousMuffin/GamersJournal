...
Se questo arriverà, secondo voi Cyberpunk 2077 ha ancora le carte in tavola per mantenere le promesse fatte?", 4, "2020-10-5", true, true, 1, 1, 16),
...
che solo oggi sembra aver trovato una sua identità ben precisa.", 3, "2020-11-16", false, false, 4, 2, 67),
...
injected humour, or non-characteristic words etc.", 4, "2021-1-9", true, true, 1, 3, 36),
...
accompanied by English versions from the 1914 translation by H. Rackham.", 2, "2021-4-24", false, false, 2, 4, 41);
...
la casa di sviluppo polacca potrebbe introdurre delle novità importanti per il suo open world Sci-Fi.", "2021-7-13", false, 1, 1, 17),
...
continua inesorabilmente ad influenzare giocatori e sviluppatori di tutto il mondo.", "2021-7-9", true, 4, 2, 68),
...
Xbox One, PC e Nintendo Switch, piattaforme sulle quali è attualmente disponibile.", "2020-5-26", false, 1, 3, 37),
...
su Switch a proseguire la propria avventura.", "2021-7-10", false, 4, 4, 42);
