...
('../immagini_progetto/videogiochi/animal_crossing/animal-crossing3.jpg'),
...
Se questo arriverà, secondo voi Cyberpunk 2077 ha ancora le carte in tavola per mantenere le promesse fatte?", 4, "2020-10-5", true, true, 1, 1, 1),
...
che solo oggi sembra aver trovato una sua identità ben precisa.", 3, "2020-11-16", false, false, 4, 2, 2),
...
injected humour, or non-characteristic words etc.", 4, "2021-1-9", true, true, 1, 3, 3),
...
accompanied by English versions from the 1914 translation by H. Rackham.", 2, "2021-4-24", false, false, 2, 4, 4);
...
insert into compatibilita (idVideogioco,idPiattaforma) values (1, 3);
