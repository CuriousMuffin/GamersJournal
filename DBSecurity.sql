...
di gioco su PlayStation, giocando su PS4 Pro e PS5.", "2021-7-13", false, 1, 1, 19);
...
fedelmente i personaggi entrati nell’immaginario collettivo nell’anno trascorso dall’uscita del gioco.
 Animal Crossing New Horizons ha venduto oltre 35 milioni di copie dal marzo 2020 ad oggi, sette milioni delle quali sono in Europa.", "2021-6-30", false, 1, 1, 3);
...
NSS x Puma x StockX dedicate a Napoli o il diorama Animal Crossing x LEGO realizzato da OrangeTeam.", "2021-7-1", false, 1, 1, 4);

insert into notizia (titolo,contenuto,datapubblicazione,bozza,idutente,idvideogioco,idimmagine) values
("STAY È UN CORTO FANMADE CON UN FINALE STRAZIANTE ISPIRATO A THE LAST OF US",
...
altro corto ispirato al gioco, The Last of Us Ellie's Revenge. Tutto questo, in attesa di conoscere
 la data di uscita della serie TV di HBO dedicata a The Last of Us che si dipanerà nel corso di 10 episodi.", "2021-7-18", false, 1, 1, 59);
...
Nel frattempo, ricordiamo a chi ci segue che sulle nostre pagine potete leggere lo speciale sull'update PS5 di The Last of Us 2 e la differenza dei 60fps.", "2021-7-14", false, 1, 1, 60);
...
Inoltre, i commercianti presso le stazioni ferroviarie vi venderanno contenitori da minatore talpa vuoti in cambio di qualche tappo. Usateli per creare e aprire contenitori pieni e ottenere ancora più bottino. L’evento inizia oggi. Qui sotto, gli orari di inizio e fine.", "2021-7-10", false, 1, 1, 23);
...
Non vediamo l’ora di goderci i vostri C.A.M.P.!", "2021-7-13", false, 1, 1, 24);
...
Se vi state avventurando solo adesso nelle lande dell'ultimo capolavoro di Capcom, o intendete farlo a breve, vi tornerà certamente comodo leggere questo nostro speciale su armi e armature più indicate per i novizi di MH Rise.", "2021-6-1", false, 1, 1, 43);
...
A chi si sta avventurando solo adesso nelle pericolose lande del capolavoro di Capcom, consigliamo di leggere questo nostro approfondimento sulle armi e le armature più indicate per i novizi di MH Rise.", "2021-7-17", false, 1, 1, 44);
...
Legion sarà acquistabile singolarmente come DLC o scaricabile come parte del Season Pass di Watch Dogs Legion.", "2021-7-21", false, 1, 1, 69);
...
Ricordiamo che Ubisoft ha di recente diffuso l'update 4.5 di Watch Dogs Legion che aggiunge diversi nuovi contenuti al gioco base, incluso l'arrivo della nonnina hacker Helen come Operatrice aggiuntiva gratis a partire da martedì 15 giugno.", "2021-6-13", false, 1, 1, 70);
...
In attesa che il settimo capitolo arrivi su PlayStation 5, vi invitiamo a ripercorrere insieme a noi la storia dell'iconica serie di Gran Turismo.", "2021-06-19", false, 1, 1, 33);

insert into notizia (titolo,contenuto,datapubblicazione,bozza,idutente,idvideogioco,idimmagine) values
("Fanatec e Gran Turismo annunciano la loro collaborazione per lo sviluppo di nuove periferiche da gioco!",
...
L'ultima avventura degli eroi Insomniac continua quindi ad ottenere grandi consensi: Ratchet & Clank Rift Apart è il gioco del 2021 preferito dal boss di PlayStation, oltre ad essere nuovamente tornato al vertice delle classifiche di vendita UK.", "2021-08-12", false, 1, 1, 49);
...
insert into notizia (titolo,contenuto,datapubblicazione,bozza,idutente,idvideogioco,idimmagine) values
("Assassin's creed Valhalla: prossimo aggiornamento potrebbe introdurre le spade a una mano",
...
Purtroppo non c'è ancora una data per l'arrivo del nuovo aggiornamento, anche se immaginiamo che non manchi molto, vista la pubblicazione del messaggio. Forse potrebbe uscire insieme a L'assedio di Parigi, la nuova espansione del gioco prevista per questa estate.", "2021-05-17", false, 1, 1, 8);

insert into notizia (titolo,contenuto,datapubblicazione,bozza,idutente,idvideogioco,idimmagine) values
("Assassin's Creed Valhalla per PC supporta il controller DualSense di PS5",
...
A proposito dell'ultimo episodio della serie Ubisoft, il DLC L'Assedio di Parigi è stato mostrato con un primo trailer all'Ubisoft Forward e arriverà questa estate, sebbene non ci sia ancora una data di uscita ufficiale.", "2021-06-02", false, 1, 1, 9);

insert into notizia (titolo,contenuto,datapubblicazione,bozza,idutente,idvideogioco,idimmagine) values
("Crash Bandicoot 4: It’s About Time è attualmente scontato per console del 43% grazie al Prime Day",
...
Ti ricordiamo che essendo un prodotto venduto sulla piattaforma di Amazon potrebbe essere soggetto a variazioni di prezzo improvvise, specialmente durante il Prime Day che le offerte si alzano o si abbassano repentinamente.
Il prezzo sul mercato per PlayStation 4 del titolo è di €69,99, ma lo andrai a pagare solo €39,99. Un grandissimo affare, conoscendo il titolo in questione.", "2021-08-20", false, 1, 1, 13);
...
\"Le notizie circa i licenziamenti di Toys for Bob non sono veritiere\", ha dichiarato un rappresentante di Activision ai microfoni di GamesIndustry.biz.
\"Non c'è stata alcuna riduzione del personale di recente presso lo studio.\"
...
Toys for Bob è entusiasta di continuare a supportare Crash Bandicoot 4: It's About Time, e più di recente a fornire supporto aggiuntivo per Call of Duty: Warzone.", "2021-08-29", false, 1, 1, 14);


insert into notizia (titolo,contenuto,datapubblicazione,bozza,idutente,idvideogioco,idimmagine) values
("007 GoldenEye in Far Cry 5, Ubisoft ha rimosso la mappa fan-made su richiesta di MGM",
...
Per tutte le novità su Far Cry 5, restate sintonizzati su IGN Italia.
", "2021-02-03", false, 1, 1, 29);
...
che sul piatto offre almeno cinquanta/sessanta ore di gioco, un cast eccezionale e un mondo aperto 
sconfinato, coerente e pieno di segreti capace di assorbirvi completamente facendovi dimenticare di 
tutti gli altri giochi a vostra disposizione. L'impatto grafico è sbalorditivo, tanto da spingere 
all'utilizzo della modalità fotografica anche chi di solito non ne fa un grande uso. 
Il vero, grosso problema di Cyberpunk 2077 in questo momento non sono l'IA, il motore fisico o i
 glitch: sono le performance su console e i requisiti hardware richiesti per goderlo al meglio delle
 possibilità su PC. Le cose andranno sicuramente a migliorare, così come il voto finale di questa recensione
 che tiene di conto anche di questi fattori. Ignorarlo comunque non sarebbe saggio, saprà lasciare il segno nella 
vostra \"carriera\" videoludica.", 4, "2021-7-5", true, true, 1, 1, 16);
...
sublime copre anche gli elementi meno riusciti. Su macchine meno potenti i compromessi possono rubare un po’ di magia.", 4, "2021-7-14", true, true, 1, 1, 17);
...
l'editor dei modelli che potrete poi copiare su indumenti e quant'altro, e così via.", 4, "2021-6-30", true, true, 1, 1, 1);

insert into recensione (titolo,contenuto,valutazione,datapubblicazione,approvato,bozza,idutente,idvideogioco,idimmagine) values
("ANIMAL CROSSING NEW HORIZONS: RECENSIONE DELLA NUOVA ESCLUSIVA SWITCH",
"Ogni volta che si parla di Animal Crossing c'è qualcuno che si dice spaesato dal concetto su cui si basa la saga Nintendo,
come se non riuscisse ad accettare il fatto che un videogame possa rifiutare totalmente il senso di sfida, mettere da parte azione e
narrazione, e focalizzarsi invece su altre sensazioni, più placide e amene. Che Animal Crossing non sia un gioco adatto a tutti i palati 
è evidente ad un primo sguardo: per rendersene conto basta osservare le cadenzate routine di personaggi che pescano, raccolgono fossili
e insetti, si prendono cura dei fiori e parlano con strani vicini zoomorfi. Ma è altrettanto lampante quale sia l'idea alla base di 
questo garbato life simulator: quella di replicare l'operosità quotidiana di chi si fa beffe della modernità, del tran tran cittadino, 
del chiasso urbano. Animal Crossing traduce in linguaggio digitale il desiderio di evasione, il bisogno di prendersi cura di sé stessi
e dei propri spazi, e forse persino l'urgenza, che molti avventurieri virtuali sentono di tanto in tanto, di riprendere fiato, soppesando le gioie di una vita \"senza mostri e senza quest\".
Animal Crossing è sempre stato questo, e New Horizons non fa eccezione: è un software che come tutti i suoi predecessori si muove 
sul labile confine fra gioco e passatempo, offrendovi uno spazio spensierato e sicuro in cui darvi appuntamento - se non con amici 
e compagni di vita - con voi stessi.
Accettando queste premesse, decidendo di addentrarsi in questo quieto mondo alternativo (che promuove, fra le altre cose, pure 
una socialità fieramente diversa da quella che viviamo sul web), ci troveremo per le mani uno degli episodi più densi e completi della
saga. New Horizons non soltanto riscrive alcune meccaniche di progressione per introdurre gradualmente tutte le funzionalità a 
disposizione del giocatore, ma si presenta sul mercato con una quantità esorbitante di oggetti, di mobili, di creaturine e vestiti; 
con l'intenzione di riuscire a stupirvi ogni giorno, strappandovi un sorriso di fronte ad un dettaglio inatteso, un soprammobile curioso,
un outfit strampalato. E poi c'è quel diavolo di Tom Nook che ha pure lanciato un suo \"programma fedeltà\", così da convincervi a giocare
ancora, e ancora, e ancora. L'idea che ci siamo fatti è che il suo scopo ultimo sia sempre quello di mettere le mani sulle nostre 
Stelline; ma intanto, se le sue Miglia riescono a darci una scusa in più per tornare sulla nostra isola, che male c'è?", 4, "2021-7-15", true, true, 1, 1, 2);
...
4, "2020-03-27", true, true, 1, 1, 21);

insert into recensione (titolo,contenuto,valutazione,datapubblicazione,approvato,bozza,idutente,idvideogioco,idimmagine) values
("FALLOUT 76 RECENSIONE: L'INIZIO DELL'APOCALISSE NEL NUOVO GIOCO BETHESDA",
...
", 4, "2021-08-12", true, true, 1, 1, 41);

insert into recensione (titolo,contenuto,valutazione,datapubblicazione,approvato,bozza,idutente,idvideogioco,idimmagine) values
("Recensione Monster Hunter Rise: la miglior caccia su Nintendo Switch ",
...
4, "2020-09-5", true, true, 1, 1, 67);

insert into recensione (titolo,contenuto,valutazione,datapubblicazione,approvato,bozza,idutente,idvideogioco,idimmagine) values
("Watch Dogs Legion, recensione del terzo stealth ad altissima tecnologia di Ubisoft",
...
E in tutto questo si concede il lusso di affascinarci con alcuni dei panorami più belli che si siano mai visti in un videogame.", 4, "2021-3-5", true, true, 1, 1, 6);
...
esattamente fra i due precedenti capitoli, laddove il punto più alto viene rappresentato da Origins.", 4, "2021-7-15", true, true, 1, 1, 7);
...
", 4, "2021-7-5", true, true, 1, 1, 48);

insert into recensione (titolo,contenuto,valutazione,datapubblicazione,approvato,bozza,idutente,idvideogioco,idimmagine) values
("Super Mario Bros 3 recensione",
